...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/07/28 19:38:13 by bclerc            #+#    #+#             */
/*   Updated: 2021/07/29 03:40:14 by bclerc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/pushswap.h"

int check_insert_position(int value, t_stack **stack)
{
    t_stack     *tmp;
    int         i;
...
// FONCTION A REDUIRE JE SAIS // SUPPRIMER 3 LIGNES
...
void five_sort(t_push *push)
{
    ...
    while (i > 0)
    {
        insert_pos = check_insert_position((*push->stackb)->value, push->stacka);
